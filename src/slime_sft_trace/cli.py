...
class Config:
    ...
    def __init__(self) -> None:
        ...
        if self.upstream_mode not in ("sglang", "messages"):
            raise ValueError(f"UPSTREAM_MODE must be 'sglang' or 'messages', got {self.upstream_mode!r}")
